// One-shot: ingest Nativz's own June Drive folder, run the full pipeline
// (download → Mux → analyze → captions → schedule_posts), and mint a
// share link. Draft mode — nothing publishes until Jack approves.
...
const FOLDER_URL =
  'https://drive.google.com/drive/folders/1xAspuyKdYVQSMY0aqdxL_n6WPSyPUNlG';
