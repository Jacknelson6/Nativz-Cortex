...
// Unified Cortex entry point. Replaces /admin/login + /portal/login — those
// routes redirect here. Brand-root migration phase 2: one login surface for
// both admins and viewers; role detection drives the post-auth redirect.
const ADMIN_HOME = '/admin/dashboard';
const VIEWER_HOME = '/finder/new';
