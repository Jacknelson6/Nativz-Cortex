...
/**
 * GET /api/reporting/posting-frequency
 *
 * Proxies /v1/analytics/posting-frequency — per-platform rows of
 * posts/week ↔ engagement-rate correlation. Lets the UI surface the
 * optimal cadence sweet-spot for each network.
 */
export async function GET(request: NextRequest) {
  ...
  const frequency = await zernio.getPostingFrequency({
