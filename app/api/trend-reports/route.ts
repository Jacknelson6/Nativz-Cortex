...
export async function GET(req: NextRequest) {
  ...
  let query = admin
    .from('trend_reports')
    .select(
      'id, subscription_id, client_id, organization_id, generated_at, period_start, period_end, summary, email_resend_id, email_status, email_error, subscription:trend_report_subscriptions(name, topic_query), client:clients(name, agency)',
    )
