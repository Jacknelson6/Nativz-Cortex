...
export async function GET(
  ...
  try {
    ...
    console.error('GET /api/analysis/boards/[id]/share error:', error);
...
export async function POST(
  ...
  try {
    ...
    console.error('POST /api/analysis/boards/[id]/share error:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('DELETE /api/analysis/boards/[id]/share error:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
