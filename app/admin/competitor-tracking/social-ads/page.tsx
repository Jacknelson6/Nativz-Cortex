...
export default async function SocialAdsComingSoonPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center p-8">
      <div className="w-full max-w-md rounded-2xl border border-nativz-border bg-surface p-8 text-center shadow-card">
        ...
        <h1 className="text-xl font-semibold text-text-primary">Social Ads</h1>
        <p className="mt-2 text-sm text-text-secondary">
          Track competitors' paid social — Meta, TikTok, and Google Ads Library — side-by-side with organic performance.
        </p>
