...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  {
    "method": "PATCH",
    "path": "/api/ad-creatives/brand-context",
    "description": "Scraped site copy can exceed 2k; cap at a safe size for JSONB */ description: z.string().max(50000), }), }); /** PATCH /api/ad-creatives/brand-context Save edited brand context back to the client's knowledge entry. Updates existing brand_profile with ad_creative_context, or creates one.",
    "auth": "",
    "section": "Ad Creatives",
    "sectionSlug": "ad-creatives"
  },
  ...
  {
    "method": "POST",
    "path": "/api/ad-creatives/scrape-brand",
    "description": "Lightweight scrape of a website to extract brand info and products for the ad generation wizard.",
    "auth": "Required",
    "section": "Ad Creatives",
    "sectionSlug": "ad-creatives",
    "body": "url - Website URL to scrape",
    "response": "{{ brand, products }}"
  },
  {
    "method": "POST",
  ...
  {
    "method": "DELETE",
    "path": "/api/clients/:id/ad-creatives",
    "description": "Delete an ad creative and its storage file.",
    "auth": "Required (admin)",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
    "body": "creativeId (single) or creativeIds (1–50) (bulk)",
    "query": "id - Client UUID",
    "response": "{{ success: true }} or {{ success: true, deletedCount }} (bulk)"
  },
  {
    "method": "GET",
    "path": "/api/clients/:id/ad-creatives",
    "description": "List ad creatives for a client with pagination and filtering.",
    "auth": "Required",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
    "query": "id - Client UUID\nis_favorite - Filter favorites\naspect_ratio - Filter by aspect ratio\nbatch_id - Filter by batch\npage - Page number (default 1)\nlimit - Items per page (default 24, max 100)",
    "response": "{{ creatives: AdCreative[], total: number, page: number, limit: number }}"
  },
  {
    "method": "PATCH",
    "path": "/api/clients/:id/ad-creatives",
    "description": "Toggle favorite status on an ad creative.",
    "auth": "Required",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
    "body": "creativeId + is_favorite (single) or creativeIds (1–50) + is_favorite (bulk)",
    "query": "id - Client UUID",
    "response": "{{ creative }} (single) or {{ updatedCount, ids }} (bulk)"
  },
  {
    "method": "GET",
    "path": "/api/clients/:id/ad-creatives/batches",
    "description": "List generation batches for a client. Supports ?status= filter.",
    "auth": "",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients"
  },
  {
    "method": "GET",
    "path": "/api/clients/:id/ad-creatives/batches/:batchId",
    "description": "Get batch status, progress counts, and list of completed creatives.",
    "auth": "Required",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
    "query": "id - Client UUID\nbatchId - Batch UUID",
    "response": "{{ batch: AdGenerationBatch, creatives: AdCreative[] }}"
  },
  {
    "method": "POST",
    "path": "/api/clients/:id/ad-creatives/batches/:batchId/cancel",
    "description": "Stops scheduling further images for this batch. Work already running (e.g. Gemini) may still finish.",
  ...
  },
  {
    ...
    "description": "Ad wizard loads client library in one request (see ad-wizard.tsx limit=500). */ limit: z.coerce.number().int().min(1).max(2000).default(24), }); /** GET /api/clients/[id]/ad-creatives/templates List custom ad prompt templates for a client.",
    "auth": "Required",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
    "query": "id - Client UUID\npage - Page number (default 1)\nlimit - Items per page (default 24, max 2000)",
    "response": "{{ templates: AdPromptTemplate[], total: number, page: number, limit: number }}"
  },
  {
    "method": "POST",
    "path": "/api/clients/:id/ad-creatives/templates",
    "description": "Upload a winning ad image and extract its prompt schema via AI vision. The image is stored in Supabase Storage, then extractAdPrompt() analyzes it in the background. The template record is created immediately with status 'extracting', and updated once extraction completes.",
    "auth": "Required (admin)",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
  ...
  {
    "method": "POST",
    "path": "/api/clients/:id/ad-creatives/templates/bulk",
    "description": "Bulk upload multiple ad images for prompt extraction. Each image is uploaded to Supabase Storage and an ad_prompt_templates record is created immediately. Gemini Vision extraction runs in the background via after().",
    "auth": "Required (admin)",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
  ...
  {
    "method": "POST",
    "path": "/api/clients/:id/ad-creatives/wizard-product-image",
    "description": "Upload a product reference image for the ad generation wizard (e.g. when scrape has no image). Stores in `brand-assets` under `{clientId}/ad-wizard-products/`.",
    "auth": "Required (admin)",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients",
  ...
  {
    "method": "GET",
    "path": "/api/clients/:id/ad-generation-settings",
    "description": "",
    "auth": "",
    "section": "Clients & Onboarding",
    "sectionSlug": "clients"
  ...
  },
  {
    ...
    "description": "Fetches Google Calendar events from multiple connections in parallel. Query params: connection_ids — comma-separated calendar_connections.id values start — ISO datetime (range start) end — ISO datetime (range end) Returns: { calendars: { [connectionId]: { name, color, connection_type, events[] } } } Client connections (connection_type='client') have event titles replaced with \"Busy\" to preserve privacy.",
    "auth": "",
