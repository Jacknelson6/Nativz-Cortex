...
This skill supplements CLAUDE.md and `.claude/rules/api-routes.md` with specific code-level checks. It does NOT duplicate those docs — it adds the "check your work" layer with concrete bad/good examples so mistakes are caught before they ship.
...
These checks supplement (not replace) the conventions in CLAUDE.md and `.claude/rules/api-routes.md`.
