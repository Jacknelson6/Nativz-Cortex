...
-- ----------------------------------------------------------------------------
-- Cache column for Instagram-feed-compatible (4:5 center-cropped) renders of
...
comment on column public.scheduler_media.feed_normalized_url is
  'Cached public URL of the 4:5 center-cropped render used for Instagram feed posts when the source aspect ratio is outside [0.8, 1.91]. NULL means either the source is already in-range or no normalization has been attempted yet.';
