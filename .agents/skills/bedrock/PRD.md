...
- [x] Skill **Northstone App UI** — id **`northstone-app-ui`**, slash **`/northstone-app-ui`** (not `bedrock`) — avoids duplicate `/bedrock` entries in Cursor next to global [Jacknelson6/bedrock](https://github.com/Jacknelson6/bedrock).
