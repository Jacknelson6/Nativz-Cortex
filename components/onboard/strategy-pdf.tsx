  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.coverPage}>
        <Text style={styles.coverBadge}>NATIVZ CORTEX</Text>
        ...
        <View style={{ ...styles.accentLine, marginTop: 40 }} />
        <Text style={{ ...styles.text, textAlign: 'center', fontSize: 9, marginTop: 10 }}>
          Generated by Nativz Cortex AI • Confidential
        </Text>
      </Page>
