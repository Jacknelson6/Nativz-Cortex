...
import { Check, Copy, Loader2, Trash2, X, Shield, Crown } from 'lucide-react';
...
export function ComptrollerShareDialog({ open, onClose, periodId, periodLabel }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="relative w-full max-w-2xl rounded-2xl border border-nativz-border bg-surface shadow-2xl">
        <div className="flex items-start justify-between border-b border-nativz-border/60 p-5">
          <div>
            <h2 className="text-lg font-semibold text-text-primary">Share read-only view</h2>
