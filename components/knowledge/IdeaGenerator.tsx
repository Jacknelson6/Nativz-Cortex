      ...
      <div className="bg-surface rounded-xl border border-nativz-border p-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 rounded-lg border border-nativz-border bg-surface px-3 py-2 text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-accent2/50 focus:ring-1 focus:ring-accent2/50 focus:shadow-[0_0_0_3px_var(--accent2-surface)] transition-colors"
          />
          ...
          <input
            ...
            className="w-24 rounded-lg border border-nativz-border bg-surface px-3 py-2 text-sm text-text-primary focus:outline-none focus:border-accent2/50 focus:ring-1 focus:ring-accent2/50 focus:shadow-[0_0_0_3px_var(--accent2-surface)] transition-colors"
            placeholder="# ideas"
          />
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent2 px-5 py-2 text-sm font-medium text-white hover:opacity-90 transition-opacity disabled:opacity-40 cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={handleGenerate}
              disabled={loading}
              className="inline-flex items-center gap-1.5 text-xs text-accent2-text hover:text-accent2-text/80 transition-colors cursor-pointer disabled:opacity-40"
            >
