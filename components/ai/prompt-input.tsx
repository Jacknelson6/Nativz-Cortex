  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        rows={1}
        disabled={disabled}
        className="min-h-[48px] w-full resize-none border-none bg-transparent pl-2 pr-4 pt-3 pb-12 text-sm text-text-primary placeholder:text-text-muted/60 outline-none leading-relaxed"
      />
