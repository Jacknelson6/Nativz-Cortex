...
//
// Overview, Search cost, and Usage tabs moved to /admin/infrastructure —
// AI settings is now just the three levers that actually configure AI
// behavior: the model, the key, and the skills.
