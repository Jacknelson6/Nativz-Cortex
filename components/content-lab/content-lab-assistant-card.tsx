...
type ContentLabAssistantCardProps = {
  clientId: string;
  clientName: string;
};
 ...
 */
export function ContentLabAssistantCard({ clientId, clientName }: ContentLabAssistantCardProps) {
  const nerdHref = `/admin/nerd?strategySource=content-lab&strategyClient=${encodeURIComponent(clientId)}`;
