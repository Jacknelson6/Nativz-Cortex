...
export type ContentLabStepperProps = {
 ...
 */
export function getContentLabFocusStep(props: ContentLabStepperProps): number {
...
export function ContentLabStepper(props: ContentLabStepperProps) {
  const focus = getContentLabFocusStep(props);
