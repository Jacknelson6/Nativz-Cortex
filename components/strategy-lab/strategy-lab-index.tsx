...
export type StrategyLabClientRow = {
  id: string;
  name: string;
  slug: string;
...
export function StrategyLabIndex({
  clients,
  userFirstName,
}: {
  clients: StrategyLabClientRow[];
    ...
    <div className="cortex-page-gutter pb-12">
      <section className="mx-auto w-full max-w-3xl pt-4 sm:pt-6 md:pt-8">
        ...
        <div className="mx-auto mt-5 w-full max-w-xl md:mt-6">
          ...
          >
            <label htmlFor="strategy-lab-client-filter" className="sr-only">
              Filter clients
            </label>
