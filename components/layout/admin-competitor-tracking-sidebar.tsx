...
import { Users, Megaphone, ShoppingBag, ChevronLeft } from 'lucide-react';
...
const ITEMS: CtItem[] = [
  ...
  { href: '/admin/competitor-tracking/social-ads', label: 'Social Ads', icon: Megaphone, comingSoon: true },
